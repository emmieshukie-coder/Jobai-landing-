...
app.get('/', (req, res) => {
  res.send(
    ...
    ' <div id="limitMsg" class="limit-msg">You used your 1 free job this month. Extra posts cost 2000 UGX.</div>' +
    ...
    ' return "<a href=\\"" + j.url + "\\" target=\\"_blank\\" class=\\"job-card\\"><span class=\\"country-tag\\">" + j.country + "</span><h3>" + j.title + "</h3><p class=\\"job-meta\\"><span>" + j.location + "</span>•<span>" + j.company + "</span></p></a>";' +
    ' }).join("");' +
    ' }' +
    ...
    ' document.getElementById("adMsg").textContent = "Payment required for extra post.";' +
...
app.post('/ads/pay', (req, res) => {
  ...
  // For now we auto-approve. Replace with real verification.
